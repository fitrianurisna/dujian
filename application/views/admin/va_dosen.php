<div class="col-md-12 col-sm-12  ">
      ...
      <div class="col-md-4">
        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addNewdosen">Tambah Dosen</button>
      </div>
      ...
      <tbody>
        ...
        <?php 
          ...
          <td><a type="button" class="btn btn-danger" href="<?= base_url() ?>Ca_dosen/delete/<?= $d->id_dosen ?>">Hapus</a></td>
        </tr>
        <?php } ?>
      </tbody>
                      </table>
...
<form action="<?php echo base_url('Ca_dosen/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 ">
              <input class="form-control" type="text" name="nama_dosen" placeholder="Nama">
            </div>
          </div>
