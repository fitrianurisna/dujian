...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/ttd/jquery-ui.css" />
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/ttd/jquery.signature.css" />
...
<body class="nav-md footer_fixed">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="<?php echo base_url('Ca_jadwal'); ?>"><i class="fa fa-archive"></i>Jadwal UTS</span></a></li>
  ...
  <script src="<?php echo base_url(); ?>assets/ttd/jquery.ui.touch-punch.min.js" type="text/javascript"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/js/bootstrap-datepicker.js"></script>
  <script>
    $(function() {
      $('#tanggalaja').datepicker({
        format: 'yyyy-mm-dd',
        autoclose: true,
        todayHighlight: true
      });
