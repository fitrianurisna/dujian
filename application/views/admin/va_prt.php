      ...
      <tbody>
        <tr>
          <?php 
              ...
              <td align="center"><a href="<?= base_url()?>C_prt/kwitansi_rtpdf/<?= $s->npm?>" class="fa fa-download" >CETAK</a></td>
              <td align="center"><a href="<?= base_url()?>C_prt/form_rt_pdf/<?= $s->npm?>" class="fa fa-download" >CETAK</a></td>
        </tr>
      <?php } ?>
      </tbody>
