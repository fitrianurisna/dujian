      ...
      <tbody>
        <tr>
          <?php 
              ...
              <td align="center"><a href="<?= base_url()?>C_uas/kwitansi_uaspdf/<?= $s->npm?>" class="fa fa-download" >CETAK</a></td>
              <td align="center"><a href="<?= base_url()?>C_uas/form_uas_pdf/<?= $s->npm?>" class="fa fa-download" >CETAK</a></td>
        </tr>
      <?php } ?>
      </tbody>
